            ...
            <div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Daftar Administrasi Desa</h2>
							</div>
						</div>
					</div>
                </div>
											...
											<tr>
												...
												<td>
													<div class="form-button-action">
														<a href="?halaman=ubah_administrasi&id=<?php echo $row['id_administrasi']; ?>" type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit User">
